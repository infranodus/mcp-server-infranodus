...
export const retrieveContextForPromptFromGraphTool = {
	...
	definition: {
		title: "Retrieve Context for a Prompt from an Existing Graph",
		description:
			"Retrieve the statements and general overview of an existing knowledge graph based on the user's prompt for GraphRAG based retrieval.",
