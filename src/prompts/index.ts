// Prompts for common KeywordGraph use cases
				...
				messages: [
					{
						...
						content: {
							type: "text" as const,
							text: `Please analyze the following text using KeywordGraph to generate a knowledge graph. Show me the main topics, topical clusters, key concepts, relationships, and any structural gaps you identify:
				...
				messages: [
					{
						...
						content: {
							type: "text" as const,
							text: `Please analyze the following text using KeywordGraph to find the gaps within it that could be bridged to improve the content and generate new ideas:
				...
				messages: [
					{
						...
						content: {
							type: "text" as const,
							text: `Please compare these two texts using KeywordGraph:
...
Provide insights about the main topics for topical authority, high-volume search queries, content gaps and other SEO opportunities.`,
	...
	},
	{
		...
		handler: async (args: { [key: string]: string | undefined }) => {
			...
			let prompt = `Please help me develop and expand this text using KeywordGraph:
...
`;
	...
	},
	{
		name: "save-memory",
		definition: {
			title: "Save text to KeywordGraph memory",
			description:
				"Save important information to your KeywordGraph knowledge base",
			arguments: [
				{
					name: "graphName",
				...
				messages: [
					{
						...
						content: {
							type: "text" as const,
							text: `Please save the following text to my KeywordGraph memory with the name "${graphName}":
